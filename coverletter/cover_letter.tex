...
\begin{center}
\large\bf Sam Swanke \\ % Your name
%\vspace{20pt} \hrule height 1pt % If you would like a horizontal line separating the name from the address, uncomment the line to the left of this text
4 Butternut Ct \\ Essex, VT 05452 \\ (802) 922-0377 % Your address and phone number
\end{center} 
\vfill

\signature{Sam Swanke} % Your name for the signature at the bottom
